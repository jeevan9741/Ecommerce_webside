...
export default async function AboutPage() {
  // Public page: no token needed. The backend returns certificates with short-lived signed URLs.
  const { settings: settingsMap, certificates: certsWithUrls } = await api.get<{
    settings: Record<string, unknown>;
    certificates: { id: string; title: string; description: string | null; url: string | null }[];
  }>("/about", { token: null });
