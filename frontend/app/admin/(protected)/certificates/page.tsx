...
export default function AdminCertificatesPage() {
  ...
  async function load() {
    const data = await backendFetch("/api/admin/certificates").then((r) => r.json());
    setCertificates(data.certificates);
  }

  useEffect(() => {
    backendFetch("/api/admin/certificates")
      .then((r) => r.json())
  ...
  async function save() {
    ...
    setSaving(true);
    setError(null);
    const res = await backendFetch("/api/admin/certificates", {
      method: "POST",
  ...
  async function remove(id: string) {
    await backendFetch(`/api/admin/certificates/${id}`, { method: "DELETE" });
    await load();
  }
